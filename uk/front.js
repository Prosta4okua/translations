export default {
  ...
  _lt: {
    ...
    default: {
      cookiesBanner: 'Ми використовуємо кукі, щоб ви   to provide the best experience. By continuing to use our website, you agree to our cookies policy. {button}',
  ...
  _cp: {
    ...
    /* Header component */
    header: {
      sidebarHint: 'Відкрийте для себе всі наші можливості, натиснувши на значок меню тут! 😉',
      logIn: 'Увійти',
    ...
    stateButton: {
      hold: 'Утримуйте, щоб підтвердити',
      submit: 'Натисніть, щоб підтвердити',
  ...
  _pg: {
    ...
    index: {
      title: 'Головна',
      description: 'Найкраще місце, щоб розважитись з друзями у Twitter! Тут ви можете не тільки перевірити статистику, але й багато чого іншого!',
      titleH1: 'Найкраще місце, щоб розважитись з друзями у Twitter!',
      titleH2: 'Тут ви можете не тільки перевірити статистику, але й багато чого іншого!',
    ...
    profile: {
      ...
      joinBeta: 'Приєднуйтесь до програми бетатестування, щоб протестувати наші функції, перш ніж вони будуть оприлюднені!',
      ...
      saveResultsDescription: 'Check this option to save your results in history (feature name + image + time). За замовчуванням ми не зберігаємо результати.',
      emojis: 'Emojis pack',
      iOSemojis: 'iOS (Apple)',
